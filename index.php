	...
	<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item">
					<a class="nav-link active" href="index.html">Who We Are
	...
	<div class="container-fluid">
		...
		<div class="row row-introduction-2">
			...
			<div class="col-sm-6 col-intro-2-desc" style="background-image: linear-gradient(130deg, #380139 50%, #b17abd)">
				<p style="color: white; font-weight: 700; font-size: 50px; padding-bottom: 20px">Our History</p>
				<p style="color: white; padding-bottom: 20px; font-size: 17px;">
		...
		<!-- (III) intro part 3 -->
		<div class="row row-corporate-value" style="padding: 100px 150px 30px 150px; align-items: center;">
			<!-- <div class="col-sm-3" style="width: 100%">
					<h4 style="font-weight: 700">CORPORATE VALUE</h4>
				</div>
				<div class="col-sm-9"><hr style="background-color: black" /></div> -->
			<div class="intro-moto" style="flex-grow: 0; font-size: 30px; margin-right: 40px;">Corporate Value</div>
			<div class="intro-separator"></div>
		</div>
		<div class="row row-corporate-value" style="padding: 0px 150px 70px 150px">
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						<div>
		...
		<div class="row row-about-us">
			<div class="col-sm-6 col-intro-2-desc" style="background-color: #f2f2f2; padding-bottom: 120px">
				...
				<a class="about-us-link" href="#" style="text-decoration: none;">Explore our mindsets &rarr;</a>
			</div>
		...
		<div class="row row-about-us">
			...
			<div class="col-sm-6 col-intro-2-desc" style="background-color: #f2f2f2; padding-bottom: 120px">
				...
				<a class="about-us-link" href="#">Transform your organization to the next level &rarr;</a>
			</div>
		</div>
		<div class="row row-about-us">
			<div class="col-sm-6 col-intro-2-desc" style="background-color: #f2f2f2; padding-bottom: 120px">
				...
				<div style="margin-bottom: 15px;">
					<a class="about-us-link" href="#">Learn how we make the goals work &rarr;</a>
				</div>
				<a class="about-us-link" href="#">Get services &rarr;</a>
			</div>
			<div class="col-sm-6" style="padding: 0px">
		...
		<div class="row row-about-us">
			...
			<div class="col-sm-6 col-intro-2-desc" style="background-color: #f2f2f2; padding-bottom: 120px">
				...
				<a class="about-us-link" href="#">Search and apply &rarr;</a>
			</div>
		</div>
		<!-- (V) intro part 5 -->
		<div class="row row-how"">
			...
			<div class="row justify-content-sm-center row-get-in-touch">
				<div class="col-sm" style="color: white; font-size: 20px;">
					<p style="color: white; font-weight: 200"> <a class="border-link" href="#">Get in touch</a> with us or <a class="border-link" href="#">find our office</a></p>
				</div>
			</div>
		</div>
	</div>
